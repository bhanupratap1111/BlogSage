  ...
  return (
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
        <div className="text-center mt-20 mb-8">
            ...
            <div className="inline-flex items-center gap-4 justify-center px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm text-primary">
            ...
            <form onSubmit={onSubmitHandler}
                ...
                className='w-full pl-4 outline-none'/> <button type="submit" className='bg-primary text-white px-8 py-2 m-1.5 rounded-3xl hover:scale-105 transition-all cursor-pointer'>Search</button>
            </form> 
        </div>
